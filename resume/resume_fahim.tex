...
\begin{list2}
\item[ - ] Programming Languages: C/C\texttt{++}, Python, C\texttt{\#}, Matlab, Java, Javascript
\item[ - ] API LIbraries: HDF5, BSD sockets, WinSock, Opengl, Boost, Windows API, Google Test
\item[ - ] Frameworks: TensorFlow, Horovod, Qt Framework, MFC, .NET Framework
